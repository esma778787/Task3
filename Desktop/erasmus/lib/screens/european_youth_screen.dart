...
import 'project_webview_screen.dart';

class EuropeanYouthScreen extends StatefulWidget {
  const EuropeanYouthScreen({super.key});

  @override
  State<EuropeanYouthScreen> createState() => _EuropeanYouthScreenState();
}

class _EuropeanYouthScreenState extends State<EuropeanYouthScreen> {
  late Future<List<dynamic>> _projects;

  @override
  void initState() {
    super.initState();
    _projects = ProjectService.fetchProjectsFromAPI(endpoint: ApiConfig.europeanYouthProjectsEndpoint);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("European Youth Projects")),
      body: SafeArea(
        child: Center(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final category = project['category'] as String? ?? 'European Youth Portal';
